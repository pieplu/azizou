...
${OBJECTDIR}/fonctions.o: fonctions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/fonctions.o fonctions.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c
...
${TESTDIR}/tests/newsimpletest1.o: tests/newsimpletest1.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/newsimpletest1.o tests/newsimpletest1.c
...
${OBJECTDIR}/fonctions_nomain.o: ${OBJECTDIR}/fonctions.o fonctions.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/fonctions_nomain.o fonctions.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -I. `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
