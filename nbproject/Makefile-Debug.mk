...
${OBJECTDIR}/filtre.o: filtre.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Wall -I. -I. -std=c99 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/filtre.o filtre.c

${OBJECTDIR}/fonctions.o: fonctions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Wall -I. -I. -std=c99 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/fonctions.o fonctions.c
...
${TESTDIR}/tests/testsFonctions.o: tests/testsFonctions.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Wall -I. -I. -I. -I. -std=c99 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testsFonctions.o tests/testsFonctions.c
...
${OBJECTDIR}/filtre_nomain.o: ${OBJECTDIR}/filtre.o filtre.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Wall -I. -I. -std=c99 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/filtre_nomain.o filtre.c;\
	else  \
...
${OBJECTDIR}/fonctions_nomain.o: ${OBJECTDIR}/fonctions.o fonctions.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Wall -I. -I. -std=c99 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/fonctions_nomain.o fonctions.c;\
	else  \
